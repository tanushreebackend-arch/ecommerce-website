    ...
    <section className="section-padding section-alt">
      <ScrollReveal>
        <div className="container-main max-w-xl">
          <h2 className="font-heading text-xl md:text-[28px] font-normal text-center text-[var(--color-heading)] mb-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 bg-white rounded-2xl p-6 border border-[var(--color-card-border)] shadow-sm">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <input
                  ...
                  className="w-full px-4 py-3 border border-[#E8E8E8] rounded-lg text-sm font-body focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]"
                />
                <input
                  type="email"
                  placeholder="Email"
              ...
              <textarea
                ...
                className="w-full px-4 py-3 border border-[#E8E8E8] rounded-lg text-sm resize-none font-body focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]"
              />
